...
`,U3=ge({opSnippet:W3}),G3={kernelName:_a,backendName:"webgl",kernelFunc:U3};function H3(n){const{inputs:e,backend:t,attrs:s}=n,{tensor:o,indices:i,updates:a}=e,{sliceRank:r,numUpdates:l,sliceSize:c,strides:u,outputSize:h}=Xs(a,i,o.shape),d=[h/c,c];if(h===0)return t.makeTensorInfo(o.shape,i.dtype);const p=Y({inputs:{x:i},backend:t,attrs:{shape:[l,r]}}),f=Y({inputs:{x:a},backend:t,attrs:{shape:[l,c]}}),m=Y({inputs:{x:o},backend:t,attrs:{shape:d}}),g=new Vh(l,r,p.shape.length,f.shape.length,u,d,!1,!0),x=t.runWebGLProgram(g,[f,p,m],m.dtype),b=Y({inputs:{x},backend:t,attrs:{shape:o.shape}});return t.disposeIntermediateTensorInfo(p),t.disposeIntermediateTensorInfo(f),t.disposeIntermediateTensorInfo(m),t.disposeIntermediateTensorInfo(x),b}const X3={kernelName:pm,backendName:"webgl",kernelFunc:H3};class j3{constructor(e,t){this.variableNames=["A"];const s=new Array(e.length);for(let a=0;a<s.length;a++)s[a]=e[a]*t[a];this.outputShape=s,this.rank=s.length;const o=Se(this.rank),i=q3(e);this.userCode=`
    ...
    `}}function lW(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,segmentIds:i}=e,{numSegments:a}=s,r=o.shape.length,l=[];let c=0;const u=Be([c],r);let h=o;u!=null&&(h=pt({inputs:{x:o},backend:t,attrs:{perm:u}}),l.push(h),c=Ge(1,r)[0]);const d=Pw(h.shape,c,a),p=M([h.shape[c]]),f=Y({inputs:{x:h},backend:t,attrs:{shape:[-1,p]}});l.push(f);const m=_c(o.dtype),g=(y,w,v,I,$)=>{const S=y.shape[0],N=y.shape[1],E=_w(N,$),_={windowSize:E,inSize:N,batchSize:S,numSegments:$},P=new rW(_,w),z=t.compileAndRun(P,[y,v],I);if(l.push(z),z.shape[1]===$)return z;const A=vy({backend:t,attrs:{start:0,stop:$,step:1,dtype:"float32"}}),O=Iy({inputs:{x:A},backend:t,attrs:{reps:[N/E]}});return l.push(A),l.push(O),g(z,w,O,I,$)},x=g(f,"unsortedSegmentSum",i,m,a),b=Y({inputs:{x},backend:t,attrs:{shape:d}});let C=b;if(u!=null){l.push(b);const y=fs(u);C=pt({inputs:{x:C},backend:t,attrs:{perm:y}})}return l.forEach(y=>t.disposeIntermediateTensorInfo(y)),C}const cW={kernelName:dc,backendName:"webgl",kernelFunc:lW};const uW=[jO,KO,QO,tL,sL,aL,lL,uL,fL,gL,yL,vL,kL,RL,AL,OL,PL,VL,WL,GL,qL,tP,sP,rP,cP,mP,xP,wP,DO,$P,RP,FP,MP,WP,GP,XP,qP,QP,t_,o_,a_,l_,u_,p_,m_,y_,w_,$_,N_,R_,F_,__,B_,G_,j_,q_,Y_,Q_,ez,nz,oz,lz,hz,fz,gz,yz,vz,Sz,Dz,RO,Az,NP,Lz,zz,Bz,AO,Hz,Kz,Zz,tM,oM,lM,hM,mM,yM,vM,$M,TM,DM,AM,PM,zM,VM,WM,GM,qM,QM,nV,uV,LO,fV,xV,CV,IV,hP,SV,TV,DV,FV,_V,OO,MV,BV,UV,HV,XV,dP,aV,KV,JV,sB,_O,rB,uB,fB,xB,wB,IB,SB,RB,AB,LB,zB,BB,HB,qB,QB,t3,JL,lV,o3,a3,l3,u3,d3,f3,g3,b3,C3,I3,k3,N3,R3,A3,O3,P3,z3,rV,GO,B3,G3,X3,K3,J3,nW,HO,oW,aW,cW,NV];for(const n of uW)xm(n);const hW="4.22.0";const FW={"tfjs-core":Mw,"tfjs-backend-cpu":zN,"tfjs-backend-webgl":NO,"tfjs-data":Wg,"tfjs-layers":iu,"tfjs-converter":zw,tfjs:hW};export{el as Abs,Bi as Acos,Wi as Acosh,PW as AdadeltaOptimizer,_W as AdagradOptimizer,zW as AdamOptimizer,MW as AdamaxOptimizer,Ui as Add,tl as AddN,Kp as All,Yp as Any,nl as ArgMax,sl as ArgMin,Gi as Asin,Hi as Asinh,ji as Atan,Xi as Atan2,qi as Atanh,rl as AvgPool,il as AvgPool3D,ol as AvgPool3DGrad,al as AvgPoolGrad,ll as BatchMatMul,cl as BatchToSpaceND,Jp as Bincount,$c as BitwiseAnd,ef as BroadcastArgs,Ny as BroadcastTo,Vk as Callback,qv as CallbackList,ul as Cast,Yi as Ceil,Zi as ClipByValue,Vp as Complex,hl as ComplexAbs,dl as Concat,pl as Conv2D,sf as Conv2DBackpropFilter,ml as Conv2DBackpropInput,xl as Conv3D,gl as Conv3DBackpropFilterV2,of as Conv3DBackpropInputV2,Ji as Cos,ea as Cosh,af as CropAndResize,rf as Cumprod,bl as Cumsum,Zv as CustomCallback,_p as DataStorage,lf as DenseBincount,cf as DepthToSpace,yl as DepthwiseConv2dNative,uf as DepthwiseConv2dNativeBackpropFilter,hf as DepthwiseConv2dNativeBackpropInput,df as Diag,Cl as Dilation2D,Er as Dilation2DBackpropFilter,Ar as Dilation2DBackpropInput,Iw as Draw,VW as ENV,Bk as EarlyStopping,ff as Einsum,ta as Elu,wl as EluGrad,BW as Environment,kc as Equal,na as Erf,sa as Exp,vl as ExpandDims,oa as Expm1,Nf as FFT,Tf as Fill,Df as FlipLeftRight,ia as Floor,aa as FloorDiv,Lw as FromPixels,Il as FusedBatchNorm,Ef as FusedConv2D,Af as FusedDepthwiseConv2D,Rr as GPGPUContext,Ff as GatherNd,$l as GatherV2,WW as GraphModel,Sc as Greater,ra as GreaterEqual,Yv as History,Pf as IFFT,kl as Identity,tf as Imag,je as InputSpec,la as IsFinite,ca as IsInf,ua as IsNan,Pp as KernelBackend,Tl as LRN,Nl as LRNGrad,fv as LayerVariable,zn as LayersModel,Sl as LeakyRelu,Nc as Less,Tc as LessEqual,_f as LinSpace,da as Log,ha as Log1p,Ay as LogSoftmax,Ec as LogicalAnd,Ac as LogicalNot,Fc as LogicalOr,UW as LogicalXor,GW as LowerBound,pr as MathBackendCPU,gr as MathBackendWebGL,HW as MatrixBandPart,Rl as Max,Fl as MaxPool,El as MaxPool3D,Dl as MaxPool3DGrad,Al as MaxPoolGrad,zf as MaxPoolWithArgmax,pa as Maximum,Ol as Mean,Ll as Min,fa as Minimum,Pl as MirrorPad,ma as Mod,XW as MomentumOptimizer,Mf as Multinomial,ga as Multiply,zl as Neg,Vf as NonMaxSuppressionV3,Wf as NonMaxSuppressionV4,Gf as NonMaxSuppressionV5,Rc as NotEqual,jW as OP_SCOPE_SUFFIX,Ml as OneHot,Vl as OnesLike,PC as Optimizer,qW as OptimizerConstructors,Bl as Pack,Wl as PadV2,KW as Pool,xa as Pow,Ul as Prelu,Gl as Prod,YW as RMSPropOptimizer,fn as RNN,jf as RaggedGather,qf as RaggedRange,Kf as RaggedTensorToTensor,Yf as Range,ZW as Rank,Bp as Real,ya as RealDiv,Ca as Reciprocal,QW as Reduction,va as Relu,wa as Relu6,Hl as Reshape,Xl as ResizeBilinear,jl as ResizeBilinearGrad,ql as ResizeNearestNeighbor,Kl as ResizeNearestNeighborGrad,Yl as Reverse,Zf as RotateWithOffset,Ia as Round,$a as Rsqrt,JW as SGDOptimizer,Jf as ScatterNd,em as SearchSorted,Zl as Select,ka as Selu,Ls as Sequential,Sa as Sigmoid,Na as Sign,Ta as Sin,Ra as Sinh,tc as Slice,oc as Softmax,Da as Softplus,ic as SpaceToBatchND,tm as SparseFillEmptyRows,nm as SparseReshape,sm as SparseSegmentMean,om as SparseSegmentSum,im as SparseToDense,ac as SplitV,Aa as Sqrt,rc as Square,Fa as SquaredDifference,Dc as StaticRegexReplace,Oa as Step,rm as StridedSlice,um as StringNGrams,hm as StringSplit,dm as StringToHashBucketFast,La as Sub,lc as Sum,hn as SymbolicTensor,Pa as Tan,_a as Tanh,Lt as Tensor,at as TensorBuffer,pm as TensorScatterUpdate,cc as Tile,fm as TopK,mm as Transform,uc as Transpose,gm as Unique,hc as Unpack,dc as UnsortedSegmentSum,eU as UpperBound,tU as Variable,fc as ZerosLike,qp as _FusedMatMul,is as abs,Oy as acos,Ly as acosh,ne as add,nU as addN,gp as all,Or as any,ko as argMax,Py as argMin,_y as asin,zy as asinh,My as atan,Vy as atan2,By as atanh,xp as avgPool,ZC as avgPool3d,$C as backend,Dw as backend_util,sU as basicLSTMCell,Wy as batchNorm,jC as batchNorm2d,qC as batchNorm3d,KC as batchNorm4d,mp as batchToSpaceND,oU as bincount,iU as bitwiseAnd,aU as booleanMaskAsync,rU as broadcastArgs,bp as broadcastTo,lU as broadcast_util,cU as browser,ye as buffer,TW as callbacks,se as cast,Uy as ceil,Dt as clipByValue,LC as clone,uU as complex,Po as concat,RC as concat1d,TC as concat2d,NC as concat3d,SC as concat4d,pW as constraints,yp as conv1d,yi as conv2d,Cp as conv2dTranspose,XC as conv3d,GC as conv3dTranspose,hU as copyRegisteredKernels,ec as cos,fp as cosh,dU as cosineWindow,Fr as cumprod,cp as cumsum,pU as customGrad,RW as data,Hh as denseBincount,fU as deprecationWarn,Gy as depthToSpace,wp as depthwiseConv2d,mU as deregisterOp,gU as device_util,xU as diag,Hy as dilation2d,bU as disableDeprecationWarnings,Ie as dispose,yU as disposeVariables,fe as div,Xy as divNoNan,jy as dot,DC as dropout,CU as einsum,mc as elu,wU as enableDebugMode,vU as enableProdMode,IU as enclosingPowerOfTwo,Jt as engine,$U as ensureShape,L as env,Ht as equal,vp as erf,qy as euclideanNorm,ps as exp,In as expandDims,Ky as expm1,EC as eye,Yy as fft,OC as fill,kU as findBackend,SU as findBackendFactory,_l as floor,Zy as floorDiv,TO as forceHalfFloat,NU as fused,pc as gather,TU as gatherND,RU as gather_util,DU as getBackend,EU as getGradient,AU as getKernel,FU as getKernelsForBackend,EW as gpgpu_util,OU as grad,LU as grads,Yt as greater,Bs as greaterEqual,Qy as ifft,PU as imag,sn as image,_U as inTopKAsync,fW as initializers,BI as input,zU as io,Jy as irfft,eC as isFinite,tC as isInf,nC as isNaN,wn as keep,MU as kernel_impls,$W as layers,Ip as leakyRelu,dp as less,Qi as lessEqual,AC as linalg,VU as linspace,BU as loadGraphModel,WU as loadGraphModelSync,mW as loadLayersModel,sC as localResponseNormalization,Mn as log,Sp as log1p,oC as logSigmoid,$p as logSoftmax,kp as logSumExp,ds as logicalAnd,pp as logicalNot,iC as logicalOr,aC as logicalXor,UU as losses,GU as lowerBound,Qt as matMul,HU as math,Es as max,Np as maxPool,YC as maxPool3d,XU as maxPoolWithArgmax,gs as maximum,Ze as mean,Uh as memory,jU as meshgrid,kW as metrics,Tp as min,gc as minimum,rC as mirrorPad,lC as mod,gW as model,SW as models,Cc as moments,qU as movingAverage,R as mul,KU as multiRNNCell,YU as multinomial,ft as neg,Lp as nextFrame,cC as norm,Ci as notEqual,Rp as oneHot,ms as ones,Pt as onesLike,Vs as op,ZU as outerProduct,sc as pad,QU as pad1d,JU as pad2d,e4 as pad3d,t4 as pad4d,uC as pool,ba as pow,Dp as prelu,n4 as print,hC as prod,s4 as profile,o4 as raggedGather,i4 as raggedRange,a4 as raggedTensorToTensor,r4 as rand,l4 as randomGamma,kC as randomNormal,c4 as randomStandardNormal,Ba as randomUniform,u4 as randomUniformInt,QC as range,h4 as ready,d4 as real,dC as reciprocal,Xp as registerBackend,bW as registerCallbackConstructor,Fy as registerGradient,xm as registerKernel,p4 as registerOp,NW as regularizers,Us as relu,pC as relu6,f4 as removeBackend,H as reshape,$o as reverse,m4 as reverse1d,g4 as reverse2d,x4 as reverse3d,b4 as reverse4d,gC as rfft,xC as round,up as rsqrt,Me as scalar,y4 as scatterND,C4 as scatter_util,w4 as searchSorted,Ep as selu,Ap as separableConv2d,xW as sequential,v4 as serialization,I4 as setBackend,$4 as setPlatform,tA as setWebGLContext,k4 as setdiff1dAsync,_N as shared,Ea as sigmoid,bC as sign,S4 as signal,rp as sin,lp as sinh,yn as slice,yc as slice1d,Fp as slice2d,bc as slice3d,wi as slice4d,N4 as slice_util,xc as softmax,za as softplus,ip as spaceToBatchND,T4 as sparse,R4 as sparseToDense,D4 as spectral,Cn as split,$n as sqrt,it as square,yC as squaredDifference,Ma as squeeze,Ws as stack,Vi as step,CC as stridedSlice,E4 as string,Ce as sub,pe as sum,_c as sumOutType,wC as tan,Va as tanh,wc as tensor,So as tensor1d,Xh as tensor2d,A4 as tensor3d,F4 as tensor4d,O4 as tensor5d,L4 as tensor6d,P4 as tensorScatterUpdate,_4 as tensor_util,z4 as test_util,T as tidy,ts as tile,M4 as time,vC as topk,Ss as train,be as transpose,Op as truncatedNormal,IC as unique,V4 as unregisterGradient,B4 as unregisterKernel,hp as unsortedSegmentSum,Io as unstack,Xt as upcastType,W4 as upperBound,U4 as util,G4 as valueAndGrad,H4 as valueAndGrads,FC as variable,X4 as variableGrads,FW as version,zw as version_converter,Mw as version_core,zN as version_cpu,iu as version_layers,NO as version_webgl,AW as webgl,DW as webgl_util,un as where,j4 as whereAsync,Ct as zeros,Ve as zerosLike};
